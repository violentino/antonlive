...
?>
<div class="navigation" id="pagination-digg">
<?
...
else
{
	...
	?>
            <div class="navigation-arrows">
                <span class="arrow"></span><span class="ctrl"> </span>&nbsp;<? if ($bPrevDisabled):?><span
                        class="disabled"><?= GetMessage("nav_prevv") ?></span><? else:?><a href="<?= $sPrevHref; ?>"
                                                                                           id="<?= $ClientID ?>_previous_page"><?= GetMessage("nav_prevv") ?></a><?endif; ?>
                &nbsp;
            </div>
            ...
            <div class="navigations-arrows">
                <? if ($bNextDisabled):?><span class="disabled"><?= GetMessage("nav_next") ?></span><? else:?><a
                    ...
                    id="<?= $ClientID ?>_next_page"><?= GetMessage("nav_next") ?></a><?endif; ?>&nbsp;<span
                        class="ctrl"></span><span class="arrow"></span>
            </div>
</div>
<?CJSCore::Init();?>
